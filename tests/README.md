...
9. DEPOSIT AS NON-BUYER      → FAIL (WRONG ROLES TILL 13)
10. ADD AS NON-BUYER         → FAIL
11. FULFILL AS NON-SELLER    → FAIL
12. RELEASE AS NON-SELLER    → FAIL
13. REFUND AS NON-BUYER      → FAIL
